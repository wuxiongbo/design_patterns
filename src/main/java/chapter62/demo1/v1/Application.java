...
import chapter62.demo1.v1.handlerchain.handler.concrete.HandlerA;
import chapter62.demo1.v1.handlerchain.handler.concrete.HandlerB;
 ...
 *      将这些 接收对象 串成一条链，并沿着这条 链 传递这个 请求，直到 链 上的某个接收对象能够处理它为止。
 *
 *
 * 核心概念：
 ...
 *    以此类推，形成一个‘链条’。
 *    链条上的每个处理器各自承担各自的处理职责，所以叫作 职责链模式。
 *
 *

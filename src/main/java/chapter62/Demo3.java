 ...
 * <p> 普通实现 </p>
 *
 * 这里列出 普通实现，与 责任链模式 对比，总结 责任链模式的优点：
 *
 * 1)职责链模式 降低代码复杂性
 *   将  大块代码逻辑  拆分成 多个小函数，
 *   将  大类  拆分成  多个小类，
 ...
 *     比如，
 *          我们还需要过滤特殊符号，按照非职责链模式的代码实现方式，我们需要修改 SensitiveWordFilter 的代码，违反开闭原则。
 ...
 *   其中，ApplicationDemo 属于  ‘客户端代码’，也就是使用框架的代码。
 *   除 ApplicationDemo 之外的代码属于敏感词过滤 ‘框架代码’ 。
 *
 *
 * 3)职责链模式 使代码更加灵活

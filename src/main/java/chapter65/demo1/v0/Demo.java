package chapter65.demo1.v0;

import chapter65.demo1.v0.iterator.ArrayIterator;
import chapter65.demo1.v0.iterator.Iterator;
 ...
 *
 * 迭代器模式主要作用是
 * 解耦 容器代码 和 遍历代码，这也印证了我们前面多次讲过的 “应用设计模式的主要目的是 解耦”。
 *
 *
 * <pre>
 * @author wuxiongbo

...
public class SubPubTest {
    ...
    public static void main(String[] args) {
        ...
        ISubscriber<String> subscriber1 = new SubscriberImpOne<>("【订阅者】1");
        ISubscriber<String> subscriber2 = new SubscriberImpOne<>("【订阅者】2");
        ...
        // 初始化 发布者
        IPublisher<String> publisher1 = new PublisherImpOne<>("【发布者】1");
        // 委托给 订阅器 发布消息

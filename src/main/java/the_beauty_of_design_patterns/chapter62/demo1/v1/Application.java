package the_beauty_of_design_patterns.chapter62.demo1.v1;

import the_beauty_of_design_patterns.chapter62.demo1.v1.handlerchain.HandlerChain;
import the_beauty_of_design_patterns.chapter62.demo1.v1.handler.concrete.HandlerA;
import the_beauty_of_design_patterns.chapter62.demo1.v1.handler.concrete.HandlerB;
 ...
 *    以此类推，形成一个‘链条’。
 *    ‘链条’上  每个处理器  各自承担 各自的处理职责，所以叫作 职责链模式。
 *
 *

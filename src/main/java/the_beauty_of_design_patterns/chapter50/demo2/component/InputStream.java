package the_beauty_of_design_patterns.chapter50.demo2.component;

import the_beauty_of_design_patterns.chapter50.demo0.Demo;
 ...
 *
 * 装饰器模式两要素：
 *   1）‘装饰器类’ 和 ‘被装饰类’(原始类)  继承 同样的父类。      （从而可多次嵌套）
 *   2）‘装饰器类’ 是对 ‘被装饰类’  相关功能的 增强，而不是 新增 其他不相关功能
 *
 *
 *
 * InputStream 源码 简化版
 ...
 *
 * 实际上， 符合“组合关系”这种代码结构  的设计模式有很多，比如：代理模式、桥接模式，还有现在的 装饰器模式。
 * 尽管它们的代码结构很相似，但是每种设计模式的意图是不同的。
 *
 *
 * 就拿比较相似的 “代理模式” 和 “装饰器模式" 来说吧，
 *
 * 代理模式 中，  代理类 附加的是跟 原始类 业务“无关”的其他功能，
 * 装饰器模式 中， 装饰器类 附加的是跟 原始类 业务“相关”的增强功能。
 *
 * <pre>
 * @author wuxiongbo
 * @date 2021/9/13

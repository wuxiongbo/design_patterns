package the_beauty_of_design_patterns.chapter50.demo0;

import the_beauty_of_design_patterns.chapter10.demo1.Main;
import the_beauty_of_design_patterns.chapter50.dependence.BufferedFileInputStream;
...
public class Demo {
    ...
    /**
     * 本示例，JDK 的设计的好处。(采用 装饰器模式)
     *
     * 我们的设计存在的问题，多个派生类，爆炸性增长。
     *
     * 我们假想的设计，主要使用的是 “继承”，这样 存在一些问题，如果 InputStream 只有一个子类 FileInputStream 的话，

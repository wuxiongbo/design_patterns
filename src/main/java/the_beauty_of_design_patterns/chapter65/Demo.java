package the_beauty_of_design_patterns.chapter65;

import the_beauty_of_design_patterns.chapter65.iterator.ArrayIterator;
import the_beauty_of_design_patterns.chapter65.iterator.Iterator;
 ...
 * 迭代器模式主要作用是
 * 解耦 '容器代码' 和 '遍历代码'，
 *      这也印证了我们前面多次讲过的：   “应用设计模式 ，主要的目的是 ———— 解耦”。
 *
 *
 * <pre>
 * @author wuxiongbo

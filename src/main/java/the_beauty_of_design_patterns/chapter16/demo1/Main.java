package the_beauty_of_design_patterns.chapter16.demo1;


import the_beauty_of_design_patterns.chapter16.demo1.framework.ApiStatInfo;
import the_beauty_of_design_patterns.chapter16.demo1.framework.ApplicationContext;
 ...
 *
 * 使用到的设计模式：
 * 工厂模式           {@link the_beauty_of_design_patterns.chapter16.demo1.module.alert.handler.AlertHandler}
 * 桥接模式           {@link the_beauty_of_design_patterns.chapter16.demo1.module.notify.v1.notification.Notification}
 * 职责链模式         {@link the_beauty_of_design_patterns.chapter16.demo1.module.alert.Alert}
 *
 *
 */
public class Main {

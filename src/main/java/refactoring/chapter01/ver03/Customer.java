...
/**
 * 修改一，函数转移：<br>
 * 现在，我可以测试转移后的新函数 {@link Rental#getCharge()} 是否正常工作。<br>
 * 想要进行测试，只要改变 {@link Customer#amountFor(Rental)} 内容，<br>
 * 使它委托调用新函数{@link Rental#getCharge()} 即可：<br>
 ...
 * <p>
 * 我喜欢尽量除去这一类临时变量。
 * 临时变量，往往引发问题，它们会导致大量参数被传来传去，而其实完全没有这种必要。

...
/**
 * 修改一，函数转移：
 * 现在，我可以测试新函数 Rental.getCharge() 是否正常工作。{@link Rental#getCharge()}
 * 想要进行测试，只要改变 Customer.amountFor() 内容，使它委托调用新函数 getCharge() 即可：
 ...
 * <p>
 * 修改二，去除多余变量：
 * 去掉 多余的 thisAmount 临时变量 {@link refactoring.chapter01.ver02.Customer#amountFor1(refactoring.chapter01.ver02.Rental)}

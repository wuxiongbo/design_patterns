...
import static chapter64.demo1.State.CAPE;
import static chapter64.demo1.State.FIRE;
import static chapter64.demo1.State.SMALL;
import static chapter64.demo1.State.SUPER;
...
public class MarioStateMachine {
    ...
    private static final State[][] transitionTable = {
            // E1    E2    E3     E4        Even
            {SUPER, CAPE, FIRE, SMALL},  // State  SMALL
            {SUPER, CAPE, FIRE, SMALL},  // State  SUPER
            {CAPE, CAPE, CAPE, SMALL},   // State  CAPE
            {FIRE, FIRE, FIRE, SMALL}    // State  FIRE
    };
